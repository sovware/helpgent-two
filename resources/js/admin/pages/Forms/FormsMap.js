...
fields = [
	/* Text Field */
	{
		...
		comparison: true,
		comparisonType: 'less-than', // less-than, less-than-equal, greater-than, greater-than-equal, max, min
		comparedValue: 100,
		errorMessage: '',
	},
];
...
fields = [
	...
	{
		id: '1', //string
		type: 'paragraph', // elementor, gutenburg, shortcode
		label: 'Graduation', //string
		description: '',
		maxLength: '',
	...
	{
		id: '1', //string
		type: 'dropdown', // elementor, gutenburg, shortcode
		label: 'Graduation', //string
		description: '',
		rules: [ isRequired, noDuplicates ],
		showValues: true,
	...
	{
		id: '1', //string
		type: 'number', // elementor, gutenburg, shortcode
		label: 'Number', //string
		description: '',
	...
	{
		id: '1', //string
		type: 'checkbox', // elementor, gutenburg, shortcode
		label: 'Graduation', //string
		description: '',
		rules: [ isRequired, noDuplicates ],
		showValues: true,
	...
	{
		id: '1', //string
		type: 'radio', // elementor, gutenburg, shortcode
		label: 'Graduation', //string
		description: '',
		rules: [ isRequired, noDuplicates ],
		showValues: true,
