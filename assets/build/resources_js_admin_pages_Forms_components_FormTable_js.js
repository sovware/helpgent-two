...
function useForms() {
  const {
    ...
    isLoading,
    error
  } = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_2__.useQuery)(['helpgent-forms'], () => (0,_lib_fetchData__WEBPACK_IMPORTED_MODULE_0__["default"])('/helpgent/admin/form'), {
